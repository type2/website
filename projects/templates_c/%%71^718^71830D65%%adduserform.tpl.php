...
:</label><input type="text" name="name" id="name" required="1" realname="<?php echo $this->_config[0]['vars']['name']; ?>
" /></div>
		<div class="row"><label for="email"><?php echo $this->_config[0]['vars']['email']; ?>
:</label><input type="text" name="email" id="email"  realname="<?php echo $this->_config[0]['vars']['email']; ?>
" /></div>
		<div class="row"><label for="pass"><?php echo $this->_config[0]['vars']['password']; ?>
:</label><input type="text" name="pass" id="pass" required="1" realname="<?php echo $this->_config[0]['vars']['password']; ?>
" /></div>
		<div class = "row"><label id = "rate"><?php echo $this->_config[0]['vars']['rate']; ?>
:</label><input type = "text" name = "rate" id = "rate" /></div>


		<div class="clear_both_b"></div>

		<div class="row"><label><?php echo $this->_config[0]['vars']['projects']; ?>
:</label>
...
" style="width:210px;"><?php echo $this->_tpl_vars['projects'][$this->_sections['project']['index']]['name']; ?>
		...
		<div class="row"><label><?php echo $this->_config[0]['vars']['role']; ?>
:</label>
...
"><?php echo $this->_tpl_vars['roles'][$this->_sections['role']['index']]['name']; ?>
					...
					<!--<input type="radio" class="checkbox" value="<?php echo $this->_tpl_vars['roles'][$this->_sections['role']['index']]['ID']; ?>
" name="role" id="role<?php echo $this->_tpl_vars['roles'][$this->_sections['role']['index']]['ID']; ?>
" realname = "<?php echo $this->_config[0]['vars']['role']; ?>
" required="1"        /><label for="role<?php echo $this->_tpl_vars['roles'][$this->_sections['role']['index']]['ID']; ?>
"><?php echo $this->_tpl_vars['roles'][$this->_sections['role']['index']]['name']; ?>
</label>-->
		...
		<div class="row">
		<label>&nbsp;</label>
		<div class="butn"><button type="submit"><?php echo $this->_config[0]['vars']['addbutton']; ?>
</button></div>
