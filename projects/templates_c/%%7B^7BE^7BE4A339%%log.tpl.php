<?php /* Smarty version 2.6.19, created on 2010-09-14 04:00:43
         compiled from log.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'log.tpl', 80, false),array('function', 'paginate_prev', 'log.tpl', 116, false),array('function', 'paginate_middle', 'log.tpl', 116, false),array('function', 'paginate_next', 'log.tpl', 116, false),)), $this); ?>
			<div class="headline">
...
">
					<?php endif; ?>
						<tr>
							...
							<img style="margin:0 0 0 3px;" src="./templates/standard/images/symbols/user.png" alt="" />
							...
							<?php elseif ($this->_tpl_vars['log'][$this->_sections['logitem']['index']]['type'] == 'datei'): ?>
							...
							<td>
								<div class="toggle-in">
									<strong><?php echo ((is_array($_tmp=$this->_tpl_vars['log'][$this->_sections['logitem']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>
</strong><br />
							...
							<td><a href = "manageuser.php?action=profile&amp;id=<?php echo $this->_tpl_vars['log'][$this->_sections['logitem']['index']]['user']; ?>
