<?php /* Smarty version 2.6.19, created on 2010-09-14 04:01:02
         compiled from projectmilestones.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'projectmilestones.tpl', 102, false),)), $this); ?>
...
<span>/ <?php echo $this->_config[0]['vars']['milestones']; ?>
			...
			<div class="headline">
				...
				<div class="wintools">
					<!--
					<a class="close" href="#"><span><?php echo $this->_config[0]['vars']['close']; ?>
</span></a>
					<a class="edit" href="#"><span><?php echo $this->_config[0]['vars']['edit']; ?>
</span></a>
					<a class="del" href="#"><span><?php echo $this->_config[0]['vars']['delete']; ?>
</span></a>
					-->
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['milestones'][$this->_sections['stone']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>
								...
								<td class="days"><?php echo $this->_tpl_vars['milestones'][$this->_sections['stone']['index']]['dayslate']; ?>
</td>
								<td class="tools">
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['latemilestones'][$this->_sections['latestone']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>
								...
								<td class="days">-<?php echo $this->_tpl_vars['latemilestones'][$this->_sections['latestone']['index']]['dayslate']; ?>
</td>
								<td class="tools">
									<?php if ($this->_tpl_vars['userpermissions']['milestones']['edit']): ?>
...
">
						...
						<?php else: ?>
							<tr>
						<?php endif; ?>
								<td class="a"><?php if ($this->_tpl_vars['userpermissions']['milestones']['close']): ?><a class="butn_checked" href="managemilestone.php?action=open&amp;mid=<?php echo $this->_tpl_vars['donemilestones'][$this->_sections['stone']['index']]['ID']; ?>
&amp;id=<?php echo $this->_tpl_vars['project']['ID']; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['donemilestones'][$this->_sections['stone']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>
								...
								<?php if (time() > $this->_tpl_vars['donemilestones'][$this->_sections['stone']['index']]['end']): ?>
									<td class="days">-<?php echo $this->_tpl_vars['donemilestones'][$this->_sections['stone']['index']]['dayslate']; ?>
</td>
								<?php else: ?>
									<td class="days"><?php echo $this->_tpl_vars['donemilestones'][$this->_sections['stone']['index']]['dayslate']; ?>
</td>
