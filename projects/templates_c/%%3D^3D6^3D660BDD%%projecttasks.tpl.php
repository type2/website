<?php /* Smarty version 2.6.19, created on 2010-09-14 04:08:36
         compiled from projecttasks.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'projecttasks.tpl', 146, false),array('modifier', 'nl2br', 'projecttasks.tpl', 170, false),)), $this); ?>
...
"><img src="./templates/standard/images/symbols/tasklist.png" alt="" /><?php echo $this->_tpl_vars['lists'][$this->_sections['list']['index']]['name']; ?>
</a>
				</h2>
...
" cellpadding="0" cellspacing="0" border="0">
					...
					<thead>
						<tr>
							...
							<th class="days"><?php echo $this->_config[0]['vars']['daysleft']; ?>
</th>
							<th class="tools"></th>
						</tr>
					</thead>
...
">
					<?php endif; ?>
						<tr <?php if ($this->_tpl_vars['lists'][$this->_sections['list']['index']]['tasks'][$this->_sections['task']['index']]['daysleft'] < 0): ?> class="marker-late"<?php elseif ($this->_tpl_vars['lists'][$this->_sections['list']['index']]['tasks'][$this->_sections['task']['index']]['daysleft'] == 0): ?> class="marker-today"<?php endif; ?>>
							<td><?php if ($this->_tpl_vars['userpermissions']['tasks']['close']): ?>
...
">
							...
							<td><?php unset($this->_sections['theusers']);
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['lists'][$this->_sections['list']['index']]['tasks'][$this->_sections['task']['index']]['users'][$this->_sections['theusers']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>
							...
							<td><?php echo $this->_tpl_vars['lists'][$this->_sections['list']['index']]['tasks'][$this->_sections['task']['index']]['daysleft']; ?>
</td>
							<td class="tools">
								<?php if ($this->_tpl_vars['userpermissions']['tasks']['edit']): ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['lists'][$this->_sections['list']['index']]['oldtasks'][$this->_sections['oldtask']['index']]['user'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 23, "...", true) : smarty_modifier_truncate($_tmp, 23, "...", true)); ?>
								...
								<td class="days"><?php echo $this->_tpl_vars['lists'][$this->_sections['list']['index']]['oldtasks'][$this->_sections['oldtask']['index']]['daysleft']; ?>
</td>
								<td class="tools">
									<?php if ($this->_tpl_vars['userpermissions']['tasks']['edit']): ?>
...
<?php endif; ?> <?php if ($this->_tpl_vars['oldlists'][0][0]): ?>
