<?php /* Smarty version 2.6.19, created on 2010-09-14 04:00:42
...
<h1><?php echo ((is_array($_tmp=$this->_tpl_vars['project']['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>
...
"><?php echo $this->_config[0]['vars']['description']; ?>
				...
				<li><a>Budget: <?php echo $this->_tpl_vars['project']['budget']; ?>
</a></li>
				<?php endif; ?><?php endif; ?>

				<li <?php if ($this->_tpl_vars['project']['daysleft'] < 0): ?>class="red"<?php else: ?>class="green"<?php endif; ?>><a><?php echo $this->_tpl_vars['project']['daysleft']; ?>
