<?php /* Smarty version 2.6.19, created on 2010-09-14 03:56:43
         compiled from calbody.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'calbody.tpl', 100, false),)), $this); ?>

<table  id="timeline1" cellpadding="0" cellspacing="1" border="0" class="thecal"">

	<thead class="calhead">
		<tr>
			<th><a class="scroll_left" href = "javascript:changeshow('manageajax.php?action=newcal&y=<?php echo $this->_tpl_vars['py']; ?>
...
','thecal','progress');"></a></th>
 ...
 <?php echo $this->_tpl_vars['y']; ?>
			...
			<th><a class="scroll_right" href = "javascript:changeshow('manageajax.php?action=newcal&y=<?php echo $this->_tpl_vars['ny']; ?>
...
.<?php echo $this->_tpl_vars['y']; ?>
			...
			<li class="link"><a href="#"><?php echo $this->_tpl_vars['langfile']['addtask']; ?>
</a></li>
			<li class="link"><a href="#"><?php echo $this->_tpl_vars['langfile']['addmilestone']; ?>
</a></li>
			</ul>
			</div>
			<?php endif; ?>
							...
							<div class="inmodal">
								<div class="miles">
									...
									<table class="acc_modal" id="acc_m" cellpadding="0" cellspacing="0" border="0">
										...
										<thead>
											<th></th>
											<th><?php echo $this->_tpl_vars['langfile']['project']; ?>
: <?php echo $this->_tpl_vars['langfile']['milestone']; ?>
</th>
...
">
											...
											<tr <?php if ($this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['milestones'][$this->_sections['stone']['index']]['daysleft'] < 0): ?> class="marker-late"<?php elseif ($this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['milestones'][$this->_sections['stone']['index']]['daysleft'] == 0): ?> class="marker-today"<?php endif; ?>>		
												...
												<td>
													<div class="toggle-in">
														<span class="acc-toggle" onclick="javascript:accord_m.activate($$('#acc_m .accordion_toggle')[<?php echo $this->_sections['stone']['index']; ?>
...
">
															<?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['milestones'][$this->_sections['stone']['index']]['pname']; ?>
:
...
" cellpadding="0" cellspacing="0" border="0">
										...
										<thead>
											<th></th>
											<th><?php echo $this->_tpl_vars['langfile']['project']; ?>
: <?php echo $this->_tpl_vars['langfile']['task']; ?>
</th>
											<th class="tools"><?php echo $this->_tpl_vars['langfile']['daysleft']; ?>
</th>
										</thead>
...
">
															<?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['tasks'][$this->_sections['task']['index']]['pname']; ?>
: 
						...
						<script type = "text/javascript">
							accord_mb_'; ?>
<?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['val']; ?>
<?php echo ' = new accordion(\'acc_mb_'; ?>
<?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['val']; ?>
<?php echo '\');
