...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'fileview.tpl', 32, false),)), $this); ?>
	<ul>
...
','deleteElement(\'iw_<?php echo $this->_tpl_vars['folders'][$this->_sections['fold']['index']]['ID']; ?>
\',\'managefile.php?action=delfolder&amp;id=<?php echo $this->_tpl_vars['project']['ID']; ?>
&amp;folder=<?php echo $this->_tpl_vars['folders'][$this->_sections['fold']['index']]['ID']; ?>
&ajax=1\')');fadeToggle('iw_<?php echo $this->_tpl_vars['folders'][$this->_sections['fold']['index']]['ID']; ?>
...
','deleteElement(\'iw_<?php echo $this->_tpl_vars['files'][$this->_sections['file']['index']]['ID']; ?>
...
','jslog');">
																...
																<?php echo ((is_array($_tmp=$this->_tpl_vars['files'][$this->_sections['file']['index']]['title'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 13, "...", true) : smarty_modifier_truncate($_tmp, 13, "...", true)); ?>

																<?php else: ?>
																<?php echo ((is_array($_tmp=$this->_tpl_vars['files'][$this->_sections['file']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 13, "...", true) : smarty_modifier_truncate($_tmp, 13, "...", true)); ?>
