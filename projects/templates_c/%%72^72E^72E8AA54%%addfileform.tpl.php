<?php /* Smarty version 2.6.19, created on 2010-09-14 04:08:46
...
" size="36" onchange = "file.value = this.value;" />
...
" ><?php echo $this->_tpl_vars['members'][$this->_sections['member']['index']]['name']; ?>
	...
	<div class="row-butn-bottom">
		...
		<button onclick="blindtoggle('form_file');toggleClass('addfile','addfile-active','addfile');toggleClass('add_file_butn','butn_link_active','butn_link');toggleClass('sm_files','smooth','nosmooth');return false;" onfocus="this.blur();"><?php echo $this->_config[0]['vars']['cancel']; ?>
</button>
	</div>
