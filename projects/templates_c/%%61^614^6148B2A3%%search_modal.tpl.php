<?php /* Smarty version 2.6.19, created on 2010-09-14 03:54:06
         compiled from search_modal.tpl */ ?>
<a href = "#logme" id = "logit" ></a>
<div id = "logme">

<div class="search-modal">
	<h2><?php echo $this->_config[0]['vars']['search']; ?>
</h2>
...
>
			<fieldset>
				...
				<div id="indicator2" style="display:none;"><img src="templates/standard/images/symbols/indicator_arrows.gif" alt="<?php echo $this->_config[0]['vars']['searching']; ?>
" /></div>
				
				<button type="submit" onfocus="this.blur()" title="<?php echo $this->_config[0]['vars']['gosearch']; ?>
"></button>
			</fieldset>
