<?php /* Smarty version 2.6.19, created on 2010-09-14 04:08:45
         compiled from projectfiles.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'paginate_prev', 'projectfiles.tpl', 104, false),array('function', 'paginate_middle', 'projectfiles.tpl', 104, false),array('function', 'paginate_next', 'projectfiles.tpl', 104, false),)), $this); ?>
...
<div class="files">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		...
		<span class="info_in_green"><img src="templates/standard/images/symbols/folder.png" alt=""/><?php echo $this->_config[0]['vars']['folderwasadded']; ?>
</span>
		<?php elseif ($this->_tpl_vars['mode'] == 'folderedited'): ?>
		<span class="info_in_yellow"><img src="templates/standard/images/symbols/folder.png" alt=""/><?php echo $this->_config[0]['vars']['folderwasedited']; ?>
</span>
		<?php elseif ($this->_tpl_vars['mode'] == 'folderdel'): ?>
		<span class="info_in_red"><img src="templates/standard/images/symbols/folder.png" alt=""/><?php echo $this->_config[0]['vars']['folderwasdeleted']; ?>
</span>
		<?php endif; ?>
	</div>
	<?php echo '
...
<h1><?php echo $this->_tpl_vars['projectname']; ?>
...
</div> </div> </div> <?php $_smarty_tpl_vars = $this->_tpl_vars;
