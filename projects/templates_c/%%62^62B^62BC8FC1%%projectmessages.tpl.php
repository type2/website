<?php /* Smarty version 2.6.19, created on 2010-09-14 04:08:40
         compiled from projectmessages.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'projectmessages.tpl', 101, false),)), $this); ?>
					...
					<div class="wintools">
					    <div class="export-main">
    							...
    							<div class="export-in"  style="width:46px;left: -46px;"> 
    								<a class="pdf" href="managemessage.php?action=export-project&amp;id=<?php echo $this->_tpl_vars['project']['ID']; ?>
...
"><span><?php echo $this->_config[0]['vars']['rssfeed']; ?>
				...
				<?php if ($this->_tpl_vars['userpermissions']['messages']['add']): ?><a class="add" href="javascript:blindtoggle('addmsg<?php echo $this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['ID']; ?>
				...
				<table id="acc_msgs" cellpadding="0" cellspacing="0" border="0">
					...
					<thead>
						<tr>
							...
							<th class="ce"><?php echo $this->_config[0]['vars']['replies']; ?>
</th>
...
','deleteElement(\'iw_<?php echo $this->_tpl_vars['messages'][$this->_sections['message']['index']]['files'][$this->_sections['file']['index']]['ID']; ?>
