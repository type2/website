<?php /* Smarty version 2.6.19, created on 2010-09-14 03:56:42
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'index.tpl', 85, false),array('modifier', 'nl2br', 'index.tpl', 227, false),)), $this); ?>
...
">
				...
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "addproject.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
				</div>
				<table id = "desktopprojects" cellpadding="0" cellspacing="0" border="0">
					...
					<thead>
						<tr>
							<th class="a"></th>
							<th class="b" onclick = "sortBlock('desktopprojects','');"><?php echo $this->_config[0]['vars']['project']; ?>
</th>
							<th class="c"><?php echo $this->_config[0]['vars']['done']; ?>
</th>
							<th class="d" onclick = "sortBlock('desktopprojects','daysleft');"><?php echo $this->_config[0]['vars']['daysleft']; ?>
</th>
							<th class="tools"></th>
						</tr>
					</thead>
...
">
					<?php endif; ?>
						<tr <?php if ($this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['daysleft'] < 0): ?> class="marker-late"<?php elseif ($this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['daysleft'] == 0): ?> class="marker-today"<?php endif; ?>>
							<td><?php if ($this->_tpl_vars['userpermissions']['projects']['close']): ?><a class="butn_check" href="javascript:closeElement('proj_<?php echo $this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['ID']; ?>
...
%</span></td>
							<td><?php echo $this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['daysleft']; ?>
</td>
							<td class="tools">
...
"><span><?php echo $this->_config[0]['vars']['rssfeed']; ?>
							...
							<!--
							<a class="pdf" href="#"><span><?php echo $this->_config[0]['vars']['pdfexport']; ?>
</span></a>
							-->
...
">
				<table id = "desktoptasks" cellpadding="0" cellspacing="0" border="0">
					...
					<thead>
						<tr>
							<th class="a"></th>
							<th class="b" onclick = "sortBlock('desktoptasks','');"><?php echo $this->_config[0]['vars']['task']; ?>
</th>
							<th class="c" onclick = "sortBlock('desktoptasks','project');"><?php echo $this->_config[0]['vars']['project']; ?>
</th>
							<th class="d" onclick = "sortBlock('desktoptasks','daysleft');"><?php echo $this->_config[0]['vars']['daysleft']; ?>
</th>
							<th class="tools"></th>
						</tr>
					</thead>
...
">
							...
							<td><a href = "managetask.php?action=showproject&amp;id=<?php echo $this->_tpl_vars['tasks'][$this->_sections['task']['index']]['project']; ?>
" ><?php echo ((is_array($_tmp=$this->_tpl_vars['tasks'][$this->_sections['task']['index']]['pname'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 25, "...", true) : smarty_modifier_truncate($_tmp, 25, "...", true)); ?>
</a></td>
...
">
					<?php endif; ?>
						<tr>
							<td><?php if ($this->_tpl_vars['userpermissions']['messages']['close']): ?><a class="butn_reply" href="managemessage.php?action=replyform&amp;mid=<?php echo $this->_tpl_vars['messages'][$this->_sections['message']['index']]['ID']; ?>
...
">
										<?php echo ((is_array($_tmp=$this->_tpl_vars['messages'][$this->_sections['message']['index']]['title'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>

									</a>
								</div>
							</td>
							<td><a href = "managemessage.php?action=showproject&amp;id=<?php echo $this->_tpl_vars['messages'][$this->_sections['message']['index']]['project']; ?>
