...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'addtimetracker.tpl', 55, false),)), $this); ?>
...
:</label>
	  		<input type = "text" class="text" style="width:80px;margin:0 6px 0 0;" id = "started" name = "started" required = "1" regexp="^\d\d:\d\d$" realname = "<?php echo $this->_config[0]['vars']['started']; ?>
 (Format: hh:mm)" />
...
:</label>
			<input  type = "text" class="text" style="width:80px;margin:0 6px 0 0;" id = "ended" name = "ended"  required = "1" regexp="^\d\d:\d\d$" realname = "<?php echo $this->_config[0]['vars']['ended']; ?>
 (Format: hh:mm)" / >
