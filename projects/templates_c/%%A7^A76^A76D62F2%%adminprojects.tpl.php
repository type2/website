<?php /* Smarty version 2.6.19, created on 2010-09-14 03:54:36
         compiled from adminprojects.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'adminprojects.tpl', 85, false),)), $this); ?>
...
">
					<?php endif; ?>
						<tr <?php if ($this->_tpl_vars['opros'][$this->_sections['opro']['index']]['daysleft'] < 0): ?> class="marker-late"<?php elseif ($this->_tpl_vars['opros'][$this->_sections['opro']['index']]['daysleft'] == 0): ?> class="marker-today"<?php endif; ?>>
							<td><?php if ($this->_tpl_vars['userpermissions']['projects']['del']): ?><a class="butn_check" href="javascript:closeElement('proj_<?php echo $this->_tpl_vars['opros'][$this->_sections['opro']['index']]['ID']; ?>
...
">
										<?php if ($this->_tpl_vars['opros'][$this->_sections['opro']['index']]['name'] != ""): ?>
										...
										<?php else: ?>
										<?php echo ((is_array($_tmp=$this->_tpl_vars['opros'][$this->_sections['opro']['index']]['desc'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>

										<?php endif; ?>
									</a>
								</div>
							</td>
							<td><div class="statusbar_b"><div class="complete" id = "completed" style="width:<?php echo $this->_tpl_vars['opros'][$this->_sections['opro']['index']]['done']; ?>
%;"></div></div><span><?php echo $this->_tpl_vars['opros'][$this->_sections['opro']['index']]['done']; ?>
%</span></td>
							<td><?php echo $this->_tpl_vars['opros'][$this->_sections['opro']['index']]['daysleft']; ?>
</td>
							<td class="tools">
...
');"></a>
																						<?php endif; ?>
																						<!-- <a class="export" href="#" title="<?php echo $this->_config[0]['vars']['export']; ?>
"></a> -->
																					</div>
																				</td>
																				<td class="thumb">
...
"></a>
																			...
																			<tr>
																				<td colspan="3"><span class="name"><a href="manageuser.php?action=profile&amp;id=<?php echo $this->_tpl_vars['opros'][$this->_sections['opro']['index']]['members'][$this->_sections['member']['index']]['ID']; ?>
" title="<?php echo $this->_tpl_vars['opros'][$this->_sections['opro']['index']]['members'][$this->_sections['member']['index']]['name']; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['opros'][$this->_sections['opro']['index']]['members'][$this->_sections['member']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 15, "...", true) : smarty_modifier_truncate($_tmp, 15, "...", true)); ?>
											...
											<?php endfor; endif; ?>
                                        										...
                                        										<p class="tags-miles">
											<strong><?php echo $this->_config[0]['vars']['adduser']; ?>
:</strong>
										</p>
										<div class = "inwrapper">
...
">
										<?php if ($this->_tpl_vars['clopros'][$this->_sections['clopro']['index']]['name'] != ""): ?>
										...
										<?php else: ?>
										<?php echo ((is_array($_tmp=$this->_tpl_vars['clopros'][$this->_sections['clopro']['index']]['desc'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, "...", true) : smarty_modifier_truncate($_tmp, 30, "...", true)); ?>

										<?php endif; ?>
									</a>
								</div>
							</td>
							<td class="c"><div class="statusbar_b"><div class="complete" id = "completed" style="width:<?php echo $this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['done']; ?>
%;"></div></div><span><?php echo $this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['done']; ?>
%</span></td>
							<td class="days"><?php echo $this->_tpl_vars['clopros'][$this->_sections['clopro']['index']]['daysleft']; ?>
</td>
							<td class="tools">
								<?php if ($this->_tpl_vars['userpermissions']['projects']['edit']): ?>
