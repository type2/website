...
def render(catalog: dict) -> str:
    ...
    parts: list[str] = []
    parts.append("<!-- Generated by generate_index.py; edit darkness_catalog.json instead of this HTML. -->")
            ...
            <nav class="navbar navbar-default" style="margin-bottom:0;border-radius:0;">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#darkness-nav" aria-expanded="false">
                        ...
                        <a class="navbar-brand" href="/">
                            <img alt="type2.com" src="/images/type2.png" style="margin-top:-14px;height:52px;">
                        </a>
                    </div>
                    <div class="collapse navbar-collapse" id="darkness-nav">
