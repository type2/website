...
/;
$AWSTATS_PATH='';
$AWSTATS_ICON_PATH='/usr/local/www/awstats/icon';
$AWSTATS_CSS_PATH='/usr/local/www/awstats/css';
$AWSTATS_CLASSES_PATH='/usr/local/www/awstats/classes';
$AWSTATS_CGI_PATH='/usr/local/www/awstats/cgi-bin';
